...
const content = {
  th: {
    ...
    hero: {
      eyebrow: "Flutter Developer & UI/UX Designer",
      line1: "สร้าง App มือถือ",
      line2: "ที่ใช่สำหรับ",
      line3: "ธุรกิจคุณ",
      sub: "รับทำ Flutter App ทั้ง iOS และ Android พร้อม UI/UX Design ที่ใช้งานง่าย ส่งมอบตรงเวลา",
      cta: "เริ่มโปรเจกต์",
  ...
  en: {
    ...
    hero: {
      eyebrow: "Flutter Developer & UI/UX Designer",
      line1: "Build Mobile Apps",
      line2: "That Drive",
      line3: "Your Business",
      sub: "Professional Flutter App Development for iOS & Android with beautiful UI/UX Design. On time. Every time.",
      cta: "Start a Project",
              ...
              <div className="reveal">
                ...
                <div className="flex flex-col gap-3 mb-10">
                  {([
                    ...
                    {icon:<MessageCircle className="w-4 h-4"/>, label:t.contact.lineLabel, val:t.contact.lineVal, href:"#", col:"#4ade80", bg:"rgba(34,197,94,0.08)", hbg:"rgba(34,197,94,0.16)", border:"rgba(34,197,94,0.22)"},
